...
function FullItensCrossbwols(){
const {allProducts,setItem,crossbows} = useSimulationContext()
...
const Produtos = crossbows?.map((arma, index) => 
...
export default FullItensCrossbwols