...
function FullItensRevolvers(){
const {allProducts,setItem,revolvers} = useSimulationContext()
...
const Produtos = revolvers?.map((arma, index) => 
...
export default FullItensRevolvers